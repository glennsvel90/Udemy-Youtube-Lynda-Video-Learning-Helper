...
ocmy := cmy
MouseGetPos, cmx, cmy
If (ocmy != cmy) || (ocmx != cmx) || (A_TimeSincePriorHotkey > 350) || (A_TimeSincePriorHotkey > DllCall("GetDoubleClickTime"))
Click Down
return
...
^!q::
	windows:=""
	WinGet, WinList, List, ahk_class ahk_class Chrome_WidgetWin_1 
	Loop % WinList
		windows.=WinList%A_Index% "`n"
	windows:=RTrim(windows,"|")
	Sort,windows
	If (WinList>win)
		win++
	else 
...
Send, ^!q
Sleep, 1000
Run, https://www.google.com/search?q=%clipboard%&oq=%clipboard%&aqs=chrome.0.69i59j0j46j0l5.1491j0j7&sourceid=chrome&ie=UTF-8
Sleep, 4000
Send, ^!q
Sleep 200
Run, https://www.google.com/search?q=%clipboard%&sxsrf=ALeKk03zuX6BOgRs4ME4bpBVw8zjdmqlLg:1589946708323&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjbp4uGxcHpAhV2mXIEHU5dAWgQ_AUoAnoECAwQBA&biw=1536&bih=763
...
::usieng::using
::notin::notion
::relatuionship::relationship
::crriculum::curriculum
::algortuims::algorithms
::disscuss::discuss
::rectifuy::rectify
::beucase::because
::probem::problem
...
::perosn::person
::og::of
::prescritption::prescription
::prescroption::prescription 
::attentino::attention
::comefort::comfort
::wtire::write
::machinge::machine
